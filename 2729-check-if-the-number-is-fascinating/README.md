<h2><a href="https://leetcode.com/problems/check-if-the-number-is-fascinating/description/">2729. Check if The Number is Fascinating</a></h2><h3>Easy</h3><hr><p>You are given an integer <code>n</code> that consists of exactly <code>3</code> digits.</p>
